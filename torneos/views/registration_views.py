...
from .mixins import (LoggedInMixin, TorneoViewMixin,
                                      ...
                                      RequireOpenMixin)
from ..forms.registration_forms import generate_question_form

from ..models.registration_model import Registration
from ..models.registration_model import RegistrationQuestionChoice as Choice
from ..models.registration_model import RegistrationQuestionResponse as Response
...
class RegistrationView(LoggedInMixin,
    ...
    def create_form_classes(self):
        ...
        current competition
        """
        questions = self.get_torneo().questions.select_related()
    ...
    def get(self, request, *_args, **_kwargs):
        ...
        if self.user_is_registered():
            msg = "You're already registered for %s" % competition.title
        ...
        return self.render_to_response({'questions': forms,
                                        'competition': self.get_torneo()})
        #return self.render_to_response({'competition': self.get_torneo()})
    ...
    def post(self, request, *_args, **_kwargs):
        ...
        try:
            if question_ids != request.session['question_ids']:
                ...
                return redirect('torneos:register_for', comp_slug=competition.slug)
        except KeyError:
        ...
        if all(f.is_valid() for _, f in forms):
            ...
            msg = 'Successfully registered for %s!' % competition.title
